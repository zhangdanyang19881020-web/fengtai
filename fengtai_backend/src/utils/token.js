...
class TokenManager {
  ...
  getTokenInfo() {
    ...
    return {
      ...
      remainingTime,
      isExpiringSoon,
      expiryDate: localStorage.getItem(TOKEN_EXPIRY_KEY) ? new Date(parseInt(localStorage.getItem(TOKEN_EXPIRY_KEY))) : null
    }
  }
...
export const getUserInfo = tokenManager.setUserInfo.bind(tokenManager)
