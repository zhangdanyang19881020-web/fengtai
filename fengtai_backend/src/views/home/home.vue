	...
	<div class="home">
		...
		<div class="card">
			...
			<div class="nav-buttons">
				...
				<router-link to="/familyRelation" class="link-btn">家族关系</router-link>
				<router-link to="/familyRelation2" class="link-btn">家族关系2</router-link>
				<router-link to="/FamilyTree" class="link-btn">FamilyTree</router-link>
